...
@section('title', 'Editar Detalle de Docente')

@section('content')
<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8 border-b border-gray-200">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Editar Detalle de Docente</h1>
            <p class="text-sm text-gray-500">Actualice el formulario para modificar el detalle del docente.</p>
        </div>
    ...
    <form action="{{ route('detalle_docente.update', $detalle->codigo) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" id="dui" name="dui" class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('dui') border-red-500 @enderror" placeholder="Ej: 00000000-0" value="{{ old('dui', $detalle->dui) }}">
                @error('dui')
