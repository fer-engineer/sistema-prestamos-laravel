...
<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8 border-b border-gray-200">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-sm text-gray-500">Información registrada del estudiante.</p>
        </div>
    ...
    <div class="border-t border-gray-200">
        <dl>
            ...
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $detalle->nie }}</dd>
            </div>
            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
    ...
    <div class="border-t border-gray-200 pt-6 flex justify-end space-x-4">
        <a href="{{ route('detalle_estudiante.edit', ['detalle_estudiante' => $detalle->codigo]) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center">
